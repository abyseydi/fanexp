...
// const mainColor = Color(0xFF216e29);
...
// === Palette Go Gaïndé (inspirée du drapeau du Sénégal) ===
const gaindeGreen = Color(0xFF007A33); // Vert Sénégal
const gaindeRed = Color(0xFFE31E24); // Rouge passion
const gaindeGold = Color(0xFFFFD100); // Or sénégalais
const gaindeWhite = Color(0xFFFFFFFF); // Blanc pur
const gaindeBlack = Color(0xFF0F0F0F); // Noir profond
const gaindeGray = Color(0xFFF6F8FB); // Fond clair doux
const gaindeDarkGray = Color(0xFF424242); // Texte secondaire

// Pour usage rapide dans ton thème :
