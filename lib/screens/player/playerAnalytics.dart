...
// lib/screens/player/player_analytics.dart
import 'dart:math';
...
class Player {
  ...
  final int goals;
  final int assists;
  final List<String> injuries; // ex: ["Ischio - J23", "Cheville - J5"]
  final double form; // 0..1
  final List<double> workload; // 6-8 dernières semaines 0..1
  final Map<String, double> metrics; // radar: 0..1
  final List<String> recentMatches; // ex: "vs MAR: 7.4", ...
