...
//   // Filtres de base – tu pourras les rendre dynamiques selon les catégories renvoyées par l’API
...
//   Future<List<ProductInterface>> _loadProducts() async {
...
//       // Exemple si ton backend renvoie { content: [...] } ou { data: [...] }
//       final list =
...
//           IconButton(
//             onPressed: () {
//               _snack(context, 'Panier (à implémenter)');
//             },
//             tooltip: 'Panier',
...
//           // Grille branchée sur l’API
//           FutureBuilder<List<ProductInterface>>(
//             future: publishedProducts,
//             builder: (context, snapshot) {
//               if (snapshot.connectionState == ConnectionState.waiting) {
//                 return SliverToBoxAdapter(child: _ShopSkeleton());
//               }
...
//                 final okQuery =
//                     query.trim().isEmpty ||
//                     p.nomProduit.toLowerCase().contains(
...
//                         final p = filtered[i];
//                         final pts = _pointsForPrice(p.prix);
//                         final canBuy = _canBuyWithPoints(p.prix);
...
// /// Card produit (branché sur ProductInterface)
...
//         product.newPrix != null &&
//         product.newPrix! > 0 &&
//         product.newPrix! < product.prix;
//     final int currentPrice = (product.newPrix != null && product.newPrix! > 0)
//         ? product.newPrix!
//         : product.prix;

//     return GestureDetector(
//       onTap: () {
//         _snack(context, 'Ouvrir ${product.nomProduit}');
//         // TODO: Navigator.push(...) vers ta page de détail produit
//       },
//       child: GlassCard(
//         child: Column(
...
//                 final oldPriceText = hasDiscount
//                     ? Opacity(
//                         opacity: .7,
//                         child: Text(
//                           _fcfa(product.prix),
...
//                           if (hasDiscount) Flexible(child: oldPriceText),
//                         ],
//                       ),
...
class _ShopState extends State<Shop> {
  ...
  Future<void> initState() async {
    super.initState();
    publishedProducts = await productService.getProducts();
  }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ElevatedButton.icon(
                      onPressed: () {
                        setState(() async {
                          publishedProducts = await productService
                              .getProducts();
                        });
                      },
