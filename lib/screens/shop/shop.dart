...
class _ShopState extends State<Shop> {
  // ------- Points & conversion -------
  // Exemple : 1 point = 100 FCFA (change le taux ici)
  static const int kFcfaPerPoint = 100;
  int userPoints = 1480; // à récupérer de ton backend / profil
              ...
              builder: (context, constraints) {
                ...
                return SliverGrid(
                  gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                    ...
                    mainAxisSpacing: 10,
                    crossAxisSpacing: 10,
                    // Laisse assez de hauteur pour image + 2 lignes + boutons
                    childAspectRatio: .50,
                  ),
      ...
      child: GlassCard(
        child: Column(
          ...
          children: [
            ...
            // Prix + Note + Points (anti-overflow)
            LayoutBuilder(
              builder: (ctx, cons) {
              ...
              child: FittedBox(
                ...
                child: ConstrainedBox(
                  ...
                  child: FilledButton.icon(
                    onPressed: canBuyWithPoints ? onBuyPoints : null,
                    style: FilledButton.styleFrom(
                      backgroundColor: canBuyWithPoints
                          ? gaindeInk
                          : gaindeInk.withOpacity(.25),
                    ...
                    icon: const Icon(Icons.loyalty_rounded, size: 18),
                    label: Text(
                      canBuyWithPoints
                          ? 'Acheter • ${_fmtPoints(points)} pts'
                          : 'Points insuffisants',
                      overflow: TextOverflow.ellipsis,
                    ),
                  ),
