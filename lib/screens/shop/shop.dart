...
//   void _handleToggleCart(ProductInterface p, bool isInCart) {
//     setState(() {
//       if (isInCart) {
//         // On retire du panier
//         _cartService.removeItem(p.id); // assure-toi que cette méthode existe
//         _snack(context, 'Produit retiré du panier');
//       } else {
//         // On ajoute au panier
//         _cartService.addItem(p);
//         _snack(context, 'Produit ajouté au panier');
//       }
//     });
//   }
...
//                             );
//                           },
//                           onToggleCart: () => _handleToggleCart(p, isInCart),
//                           onTap: () {
//                             Navigator.push(
//                               context,
//                               MaterialPageRoute(
...
//                     bgColor: isInCart ? gaindeGreenSoft : gaindeGreen,
//                     textColor: isInCart ? gaindeGreen : Colors.white,
//                   ),
//                 ),
//               ),
//             ),
